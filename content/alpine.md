...
## If you want all
`apk add nano git curl wget openssh build-base bash flatpak flatpak-builder streamlink lazydocker docker docker-cli docker-compose python3 py3-pip nodejs npm shadow go openjdk21 yt-dlp btop newsboat yazi mpv ffmpeg lscpu`
