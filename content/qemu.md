...
# WHPX acceleration
qemu-system-x86_64 -accel whpx -m 4G -boot d -cdrom "C:\Users\Zaxos\Downloads\debian.iso" -hda zatsvm.img -smp cores=2 -net nic -net user
qemu-system-x86_64 -accel whpx -m 4G -hda "C:\Users\Zaxos\zatsvm.img" -smp cores=2 -net nic -net user
